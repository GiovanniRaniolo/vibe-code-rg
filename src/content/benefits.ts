export const benefitsContent = {
  ...
  subtitle:
    "Ogni settimana costruisci un progetto reale che entra nel tuo portfolio.\nDall'HTML alla tua app full-stack in produzione.",
  curriculum: {
    intro: 'Dal setup AI al tuo MVP online in 7 settimane:',
    items: [
      ...
      'Lezione 5: Backend Node.js (Express API, middleware, authentication, REST)',
      'Lezione 6: Database (MongoDB, Mongoose, aggregation, real-time)',
      'Lezione 7: Deploy e MVP Finale (Vercel, Digital Ocean, CI/CD, tuo progetto)',
    ],
  },
  included: {
    title: 'Cosa Ottieni',
    items: [
      {
        icon: 'users',
        text: 'Max 12 partecipanti con supporto 1-to-1 personalizzato in aula',
      },
      {
        icon: 'code',
